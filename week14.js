...
const myFirstArray = ['hello everyone', 14, 20, 'guten abend', true, false, 29];
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = [15, 20, 'today is 8th of november', true, 2000];
...
const myInformation = ['Anastasia', 22, 'november', 'scorpio'];
...
russianCities = ['Санкт-Петербург', 'Екатеринбург', ...russianCities];
...
const filterEvenNumbers = numbers.filter(elem => elem % 2 === 0);
...
function sortAndPrint(randomNumbers) {
    const sortedNumbers = [...randomNumbers].sort((itemA, itemB) => itemA - itemB);
